...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if Deteksi_Karakter.checkIfPossibleChar(possibleChar):                   # if contour is a possible char, note this does not compare to other chars (yet) . . .
...
def extractPlate(imgOriginal, listOfMatchingChars):
    possiblePlate = Possible_Plat.PossiblePlate()           # this will be the return value
