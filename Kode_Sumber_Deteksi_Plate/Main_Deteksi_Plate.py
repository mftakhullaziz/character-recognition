...
def main():
    ...
    imgOriginalS: None = cv2.imread("Sample_Plat/31.jpeg")  # Proses membaca Citra dari folder Sample_Plat
    ...
    if len(listOfPossiblePlates) == 0:  # Kondisi ketika plat tidak terdeteksi
        ...
        cv2.imwrite("Citra_Hasil/citra_hasil_31.jpeg", imgOriginalScene)
